 ...
 */
export async function apexPoliceRequest(
  client: AcuvityCore,
  request: components.Policerequest,
  options?: RequestOptions,
): Promise<
  Result<
    components.Policeresponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => components.Policerequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/_acuvity/police")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.Policeresponse$inboundSchema),
