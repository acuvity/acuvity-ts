...
export const startCommand = buildCommand({
  ...
  parameters: {
    flags: {
      ...
      cookie: {
        kind: "parsed",
        brief: "Sets the cookie auth field for the API",
        optional: true,
        parse: (value) => {
          return z.string().parse(value);
        },
      ...
      "apex-domain": {
        kind: "parsed",
        brief: "Sets the apex_domain variable for url substitution",
        optional: true,
        parse: (value) => value,
      },
      "apex-port": {
        kind: "parsed",
        brief: "Sets the apex_port variable for url substitution",
        optional: true,
        parse: (value) => value,
      },
      "log-level": {
