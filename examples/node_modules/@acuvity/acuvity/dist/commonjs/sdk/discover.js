...
exports.discoverApex = discoverApex;
const jwt_decode_1 = require("jwt-decode");
const http_js_1 = require("../lib/http.js");
async function discoverApex(options = {}) {
    ...
    const client = isBrowser
        ? new http_js_1.HTTPClient()
        : new http_js_1.HTTPClient({ fetcher: (input, init) => {
                if (init == null) {
...
async function fetchWellKnownApexInfo(isBrowser, apiURL, token, client, iteration = 0) {
    if (iteration >= 3) {
